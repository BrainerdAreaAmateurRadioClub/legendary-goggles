...
Weather information will be collected by the Raspberry Pi 3 with either a serial interface, a USB interface, or by decoding packets with a RTL-SDR dongle.
